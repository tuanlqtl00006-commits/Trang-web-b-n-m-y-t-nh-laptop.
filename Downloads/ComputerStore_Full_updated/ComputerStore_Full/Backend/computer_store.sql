...
(N'Desktop Gaming', N'Gaming desktop computers', N'http://localhost:8080/uploads/MSI GE76 Raider.png', N'ACTIVE'),
...
(N'PC Custom', N'Custom-built computers', N'http://localhost:8080/uploads/ASUS VivoBook 15.png', N'ACTIVE'),
...
VALUES
(N'ASUS ROG Zephyrus G14', 25000000, 15, N'http://localhost:8080/uploads/ASUS ROG Zephyrus G14.png', N'Gaming laptop mạnh mẽ', N'ACTIVE', N'1TB NVMe', N'NVIDIA RTX 4090', N'14 inch QHD+', N'Windows 11', 1, 1, 1, 1),
(N'Dell XPS 15', 22000000, 12, N'http://localhost:8080/uploads/Dell XPS 15.png', N'Laptop cao cấp cho designer', N'ACTIVE', N'512GB NVMe', N'NVIDIA RTX 4080', N'15.6 inch OLED', N'Windows 11', 1, 2, 2, 2),
(N'HP Pavilion 15', 12000000, 25, N'http://localhost:8080/uploads/HP Pavilion 15.png', N'Laptop văn phòng thông dụng', N'ACTIVE', N'256GB SSD', N'Intel UHD', N'15.6 inch FHD', N'Windows 11', 2, 3, 3, 3),
(N'Lenovo ThinkPad X1', 18000000, 20, N'http://localhost:8080/uploads/Lenovo ThinkPad X1.png', N'Laptop doanh nhân đỉnh cao', N'ACTIVE', N'512GB SSD', N'Intel Iris', N'14 inch 2K', N'Windows 11', 2, 4, 2, 2),
(N'Acer Swift 5', 15000000, 18, N'http://localhost:8080/uploads/Laptop Acer Swift 5.png', N'Ultrabook nhẹ và mạnh', N'ACTIVE', N'512GB SSD', N'Intel Iris', N'14 inch FHD', N'Windows 11', 6, 5, 3, 2),
(N'MSI GE76 Raider', 24000000, 10, N'http://localhost:8080/uploads/MSI GE76 Raider.png', N'Gaming laptop pro', N'ACTIVE', N'1TB NVMe', N'NVIDIA RTX 4080 Ti', N'17 inch FHD 240Hz', N'Windows 11', 1, 6, 1, 1),
(N'Razer Blade 15', 26000000, 8, N'http://localhost:8080/uploads/Razer Blade 15.png', N'Gaming laptop siêu mỏng', N'ACTIVE', N'1TB SSD', N'NVIDIA RTX 4090', N'15.6 inch QHD', N'Windows 11', 1, 7, 1, 1),
(N'MacBook Pro 14', 28000000, 5, N'http://localhost:8080/uploads/MacBook Pro 14.png', N'Laptop sáng tạo chuyên nghiệp', N'ACTIVE', N'512GB SSD', N'Apple M3 Pro', N'14 inch Liquid Retina', N'macOS', 6, 8, 1, 2),
(N'Samsung Galaxy Book4', 16000000, 14, N'http://localhost:8080/uploads/Samsung Galaxy Book4.png', N'AMOLED laptop từ Samsung', N'ACTIVE', N'256GB SSD', N'Intel Arc', N'14 inch AMOLED', N'Windows 11', 2, 9, 3, 3),
(N'LG UltraPC', 17000000, 11, N'http://localhost:8080/uploads/LG UltraPC.png', N'Laptop với màn hình OLED', N'ACTIVE', N'512GB SSD', N'Intel Iris', N'14 inch OLED', N'Windows 11', 6, 10, 2, 2),
(N'ASUS VivoBook 15', 11000000, 30, N'http://localhost:8080/uploads/ASUS VivoBook 15.png', N'Laptop nhập môn giá tốt', N'ACTIVE', N'256GB SSD', N'AMD Radeon', N'15.6 inch FHD', N'Windows 11', 2, 1, 7, 3),
(N'Dell Inspiron 16', 13000000, 22, N'http://localhost:8080/uploads/Dell Inspiron 16.png', N'Laptop 16 inch cho công việc', N'ACTIVE', N'512GB SSD', N'Intel UHD', N'16 inch FHD', N'Windows 11', 2, 2, 3, 2),
(N'HP Spectre x360', 20000000, 9, N'http://localhost:8080/uploads/HP Spectre x360.png', N'Convertible laptop cao cấp', N'ACTIVE', N'512GB SSD', N'Intel Iris', N'13.5 inch 3K OLED', N'Windows 11', 6, 3, 2, 2),
(N'Lenovo IdeaPad Gaming 3', 14000000, 19, N'http://localhost:8080/uploads/Lenovo IdeaPad Gaming 3.png', N'Gaming laptop tầm trung', N'ACTIVE', N'512GB SSD', N'NVIDIA RTX 4050', N'15.6 inch 144Hz', N'Windows 11', 1, 4, 5, 2),
(N'Acer Nitro 5', 16000000, 16, N'http://localhost:8080/uploads/Acer Nitro 5.png', N'Gaming laptop giá rẻ', N'ACTIVE', N'512GB SSD', N'NVIDIA RTX 4060', N'15.6 inch 144Hz', N'Windows 11', 1, 5, 5, 2),
(N'ASUS TUF Gaming A16', 23000000, 7, N'http://localhost:8080/uploads/ASUS TUF Gaming A16.png', N'Gaming laptop bền bỉ', N'ACTIVE', N'1TB SSD', N'NVIDIA RTX 4070', N'16 inch 165Hz', N'Windows 11', 1, 1, 4, 1),
(N'Dell G15', 18000000, 13, N'http://localhost:8080/uploads/Dell G15.png', N'Gaming laptop cân bằng', N'ACTIVE', N'512GB SSD', N'NVIDIA RTX 4050 Ti', N'15.6 inch 165Hz', N'Windows 11', 1, 2, 4, 2),
(N'HP Victus 15', 17000000, 15, N'http://localhost:8080/uploads/HP Victus 15.png', N'Gaming laptop HP', N'ACTIVE', N'512GB SSD', N'NVIDIA RTX 4050', N'15.6 inch 144Hz', N'Windows 11', 1, 3, 5, 2),
(N'Lenovo Legion 7i', 24000000, 6, N'http://localhost:8080/uploads/Lenovo Legion 7i.png', N'Gaming laptop flagship Lenovo', N'ACTIVE', N'1TB SSD', N'NVIDIA RTX 4090', N'16 inch QHD+ 240Hz', N'Windows 11', 1, 4, 1, 1),
(N'MSI Stealth 17', 25000000, 8, N'http://localhost:8080/uploads/MSI Stealth 17.png', N'Gaming laptop mỏng nhẹ MSI', N'ACTIVE', N'1TB SSD', N'NVIDIA RTX 4080', N'17 inch FHD 240Hz', N'Windows 11', 1, 6, 1, 1);

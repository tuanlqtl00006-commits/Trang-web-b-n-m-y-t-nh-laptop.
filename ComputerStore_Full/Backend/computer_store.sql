...
CREATE TABLE orders (
    ...
    -- Cột phục vụ cơ chế Ẩn đơn hàng (Soft-Delete)
...
INSERT INTO orders
(user_id, customer_name, phone, address, payment_method, subtotal, vat, total, status, order_date, cancellation_reason, is_hidden, hidden_at, hidden_by)
VALUES
(3, N'Trần Thị B', N'0902345678', N'123 Nguyễn Huệ, TP HCM', N'Credit Card', 25000000, 2500000, 27500000, N'PENDING', SYSDATETIME(), NULL, 0, NULL, NULL),
(4, N'Phạm Văn C', N'0903456789', N'456 Lê Lợi, Hà Nội', N'Bank Transfer', 22000000, 2200000, 24200000, N'CONFIRMED', SYSDATETIME(), NULL, 0, NULL, NULL),
(5, N'Đỗ Thị D', N'0904567890', N'789 Trần Hưng Đạo, Đà Nẵng', N'E-Wallet', 12000000, 1200000, 13200000, N'SHIPPING', SYSDATETIME(), NULL, 0, NULL, NULL),
(6, N'Bùi Văn E', N'0905678901', N'321 Nguyễn Trãi, Cần Thơ', N'Credit Card', 18000000, 1800000, 19800000, N'COMPLETED', SYSDATETIME(), NULL, 0, NULL, NULL),
(3, N'Trần Thị B', N'0902345678', N'123 Nguyễn Huệ, TP HCM', N'Bank Transfer', 15000000, 1500000, 16500000, N'PENDING', SYSDATETIME(), NULL, 0, NULL, NULL);

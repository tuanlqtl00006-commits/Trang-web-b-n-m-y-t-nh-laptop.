...
Hệ thống quản lý bán máy tính/laptop xây dựng bằng Spring Boot 3, SQL Server và Docker.

## Yêu Cầu

- Java 17+
- Maven 3.9+
- SQL Server 2019+ (hoặc Docker image mcr.microsoft.com/mssql/server)
...
# spring.datasource.url=jdbc:sqlserver://localhost:1433;databaseName=ComputerStore;encrypt=true;trustServerCertificate=true

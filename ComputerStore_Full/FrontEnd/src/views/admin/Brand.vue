    ...
    <table class="table align-middle bg-white">
      ...
      <tbody>
        <tr v-for="item in pagedItems" :key="item.id">
          ...
          <td>
            <button v-if="isAdmin" class="btn btn-sm btn-outline-primary me-1" @click="openEdit(item)" title="Sửa thương hiệu">
              <i class="bi bi-pencil"></i>
            </button>
            <button v-if="isAdmin" class="btn btn-sm btn-outline-danger" @click="remove(item)" title="Xóa thương hiệu (chỉ admin)">

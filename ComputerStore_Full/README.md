...
- **Backend**: Spring Boot 3 + Java 17 + PostgreSQL (REST API)
...
- PostgreSQL: localhost:5432 (user: postgres / pass: 12345)
...
```bash
cd Backend
# Cấu hình PostgreSQL trong application.properties (nếu chưa có DB, tạo database "ComputerStore" và chạy computer_store.sql)
